...
```{r}
#private
barres = read.csv("barreslab_rnaseq.csv",stringsAsFactors = F,row.names = "Gene.symbol")
...
colnames(barres)[9] = paste0(colnames(barres)[coi],"_Specificity")
```
