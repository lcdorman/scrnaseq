...
```{r}
genes = read.csv(file.path(dir,"Spreadsheets",genefilename),stringsAsFactors = F)
...
#velocitygenes = read.csv("https://github.com/lcdorman/scrnaseq/blob/master/splicegenes.csv",stringsAsFactors = F)
