...
```{r}
column = "celltype"
ncells = 500 #if you want to include all cells just set this really high
```
...
markers_all = FindAllMarkers(
  ...
  min.pct = 0.10, 
  logfc.threshold = 0.0)
write.csv(markers_all,file = file.path(dir,"Spreadsheets",paste0(iterationname,"_celltype_markers.csv")))
```

```{r}
#read in a de gene file

markers = read.csv(file.path(dir,"Spreadsheets",paste0(iterationname,"_celltype_markers.csv")),stringsAsFactors = F)
