...
save(sobject,file = file.path(dir,datafolder,paste0(project,iterationname,"_filtered_labelled_clustered.RData")))
```
...
tree = sobject@tools$BuildClusterTree
setEPS()
postscript(file.path(dir,QCfolder,paste0(project,"_tree_",iterationname,".eps")))
plot.phylo(tree, use.edge.length = T, direction = "rightwards")
dev.off()
```
