...
organism = "Mouse"
defile = "allmarkers_vargenesMG_0501.csv"
```
...
de = read.csv(file.path(dir,"Spreadsheets",filename),stringsAsFactors = F) #any spreadsheet with gene symbols or other identifiers
ids=de$gene 
...
save(sobject,file = file.path(dir,datafolder,paste0(project,"_cellcycle.RData")))
```
...
#save seurat object with cell cycle scoring
save(sobject2,file = file.path(dir,datafolder,paste0(Project(sobject),"_cellcycleregressed.RData")))
```
