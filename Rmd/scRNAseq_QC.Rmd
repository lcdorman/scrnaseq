...
*Edit the following code every time* and make sure the folders "QC" and "Seurat"... are present in the "dir" folder above
```{r}
...
```{r}
save(sobject,file = file.path(dir,datafolder,paste0(project,"_beforeQC.RData")))
```
