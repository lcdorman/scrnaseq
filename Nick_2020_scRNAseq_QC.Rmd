...
title = "nCount"
title
hist(sobject$nCount_RNA,freq = F,breaks = 20)
table = do.call("cbind", tapply(sobject$nCount_RNA,sobject$sample_description,quantile,probs=seq(0,1,0.1)))



boxplot(table,axes = F, ylab = "", xlab = "")
